...
assert 4 "int x; int main(){ x=2; int x; x=4; return x; }"
assert 7 "int x; int y; int main(){ x=2; y=3; int x; x=4; return x+y; }"
assert 3 "int main(){ char x[3]; x[0]=-1; x[1]=2; int y; y=4; return x[0]+y; }"
assert 2 "int main(){ char x; x=2; return x; }"
assert 255 "int main(){ char x; x=-1; return x; }"
assert 104 "int main(){ char *p; p=\"hello\"; return p[0]; }"  // 'h' = 104
assert 0 "int main(){ printf(\"hello\\n\"); return 0; }"
assert 0 "int main(){ int i; i=0; while(i<5){ printf(\"hello \"); i=i+1; } return 0; }"
